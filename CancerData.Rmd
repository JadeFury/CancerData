...
## logistic regression
```{r}
# taking the only the means as a test
can = cancer[2:12]
can
...
summary(glm.fit)
```
theres various information in the summary but look at the coefficients, we have estimate, SE, z-score, and p-value, the p-value that is less than 0.05 indicates significance, that those variable has an impact on either cancer being M or B (acording to this site im reading at least)
